...
var (
	userLinkColumns               = []string{"id", "organization_id", "repository_id", "user_id", "link_id", "created_at", "action"}
...
func (o UserLinkSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UserLink slice provided for delete all")
	}
