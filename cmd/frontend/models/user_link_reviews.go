...
var (
	...
	userLinkReviewColumnsWithoutDefault = []string{"user_id", "link_id", "reviewed_at"}
	userLinkReviewColumnsWithDefault    = []string{"created_at", "updated_at"}
...
type (
	...
	// This should generally be used opposed to []UserLinkReview.
...
func UserLinkReviews(mods ...qm.QueryMod) userLinkReviewQuery {
	...
	return userLinkReviewQuery{NewQuery(mods...)}
}
