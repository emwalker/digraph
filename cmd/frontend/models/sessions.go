...
var (
	sessionColumns               = []string{"id", "session_id", "user_id"}
	sessionColumnsWithoutDefault = []string{"user_id"}
	sessionColumnsWithDefault    = []string{"id", "session_id"}
...
func (o SessionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Session slice provided for delete all")
	}
