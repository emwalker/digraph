...
func userLinkTopicBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func userLinkTopicAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *UserLinkTopic) error {
	*o = UserLinkTopic{}
	return nil
}

func testUserLinkTopicsHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, userLinkTopicDBTypes, false); err != nil {
		t.Errorf("Unable to randomize UserLinkTopic object: %s", err)
	}

	AddUserLinkTopicHook(boil.BeforeInsertHook, userLinkTopicBeforeInsertHook)
	...
	userLinkTopicBeforeInsertHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.AfterInsertHook, userLinkTopicAfterInsertHook)
	...
	userLinkTopicAfterInsertHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.AfterSelectHook, userLinkTopicAfterSelectHook)
	...
	userLinkTopicAfterSelectHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.BeforeUpdateHook, userLinkTopicBeforeUpdateHook)
	...
	userLinkTopicBeforeUpdateHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.AfterUpdateHook, userLinkTopicAfterUpdateHook)
	...
	userLinkTopicAfterUpdateHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.BeforeDeleteHook, userLinkTopicBeforeDeleteHook)
	...
	userLinkTopicBeforeDeleteHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.AfterDeleteHook, userLinkTopicAfterDeleteHook)
	...
	userLinkTopicAfterDeleteHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.BeforeUpsertHook, userLinkTopicBeforeUpsertHook)
	...
	userLinkTopicBeforeUpsertHooks = []UserLinkTopicHook{}

	AddUserLinkTopicHook(boil.AfterUpsertHook, userLinkTopicAfterUpsertHook)
	...
	userLinkTopicAfterUpsertHooks = []UserLinkTopicHook{}
}
...
func testUserLinkTopicsUpdate(t *testing.T) {
	...
	if len(userLinkTopicColumns) == len(userLinkTopicPrimaryKeyColumns) {
...
func testUserLinkTopicsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(userLinkTopicColumns, userLinkTopicPrimaryKeyColumns) {
		fields = userLinkTopicColumns
	} else {
