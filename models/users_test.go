...
var (
	userDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `GithubAvatarURL`: `character varying`, `GithubUsername`: `character varying`, `ID`: `uuid`, `Name`: `character varying`, `PrimaryEmail`: `USER-DEFINED`, `UpdatedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
