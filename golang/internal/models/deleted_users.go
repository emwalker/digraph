...
var DeletedUserTableColumns = struct {
	ID        string
	UserID    string
	DeletedAt string
}{
	ID:        "deleted_users.id",
	UserID:    "deleted_users.user_id",
	DeletedAt: "deleted_users.deleted_at",
}
...
var (
	...
	deletedUserGeneratedColumns      = []string{}
)

type (
	// DeletedUserSlice is an alias for a slice of pointers to DeletedUser.
	// This should almost always be used instead of []DeletedUser.
...
func DeletedUsers(mods ...qm.QueryMod) deletedUserQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"deleted_users\".*"})
	}

	return deletedUserQuery{q}
}
